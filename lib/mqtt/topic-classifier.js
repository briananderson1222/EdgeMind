...
const TOPIC_PATTERNS = [
  ...
  // Enterprise B: Site-level OEE metrics (short path)
  {
  ...
  // Enterprise B: Site-level production inputs (short path)
  {
...
function extractPayloadValue(payload) {
  if (payload.startsWith('{')) {
    try {
      ...
      const value = json.value !== undefined ? json.value : payload;
