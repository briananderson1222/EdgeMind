...
const equipmentStateCache = {
  ...
  CACHE_TTL_MS: 10 * 60 * 1000, // 10 minutes - Enterprise B updates every ~5 min
  STATE_CODES: {
...
/**
 * Alarm state cache.
 * Tracks active alarms across all enterprises.
 */
const alarmCache = {
  alarms: new Map(), // Map<alarmKey, alarmData>
  CACHE_TTL_MS: 30 * 60 * 1000 // 30 minutes
};

/**
 * Work order cache.
 * Tracks active work orders across all enterprises.
 */
const workOrderCache = {
  workOrders: new Map(), // Map<workOrderKey, workOrderData>
