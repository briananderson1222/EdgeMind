...
2. For EACH enterprise, use get_oee_breakdown to see OEE components (Availability, Performance, Quality)
3. If Availability is low for any enterprise, use get_equipment_states to find DOWN/IDLE machines
4. If Quality is low or defects are high, use get_downtime_analysis to quantify the problem
5. Maximum 9 tool calls per analysis (3 per enterprise)
