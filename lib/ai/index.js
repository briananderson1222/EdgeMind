...
**IMPORTANT**: This data comes from a virtual/simulated factory demonstration system. Key characteristics:
- Metrics naturally have LOW VARIANCE - this is expected behavior, NOT a data collection failure
- Values changing by <1% between intervals is NORMAL for this system
- Stable readings (0% change) indicate the simulation is running correctly
- Do NOT flag low variance or stable metrics as "data stagnation" or "integrity issues"
- Focus anomaly detection on: threshold breaches, values outside safe ranges, and waste/defect spikes
`;
